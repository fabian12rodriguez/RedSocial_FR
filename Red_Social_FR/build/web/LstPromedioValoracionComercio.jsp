...
<html>
    ...
    <body>
        ...
        <div class = "row text-center justify-content-center"> 
            ...
            <div class = "col-6">
                <br>
                <h3>Promedio de valoracion de cada comercio</h3>
                <br>
                <table class="table table-striped table-primary">
                    ...
                    <c:forEach items="${gestor.obtenerPromedioComercio}" var="item">
                        <tr>
                            <th scope="row">${item.id_comercio}</th>
                            <th scope="row">${item.nombre_comercio}</th>
                            <th scope="row">${item.promedio_valoracion} estrellas</th>
                        </tr>				
                    </c:forEach>
                </table>
